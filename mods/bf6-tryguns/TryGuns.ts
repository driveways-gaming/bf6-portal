...
export async function OnPlayerDied(player: mod.Player, eventOtherPlayer: mod.Player, eventDeathType: mod.DeathType, eventWeaponUnlock: mod.WeaponUnlock) {
...
class PlayerState {
    ...
    static getState(playerId: number): PlayerData {
        ...
        if (!state) {
            state = { alive: false, selectedWeaponCategory: "", selectedAttachmentCategory: "", selectedAttachments: new Map(), selectedWeapon: "" };
