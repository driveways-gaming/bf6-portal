...
export function OngoingPlayer(player: mod.Player) {
    ...
    if (tick % 30 == 0) {
        ...
        //  else {
        //     // AI bot: ensure they stay at their position
        //     const playerId = mod.GetObjId(player);
        //     const slot = PlayerIdToSlot.get(playerId);
        //     if (slot !== undefined) {
        //         mod.AIMoveToBehavior(player, BotPositionVectors[slot]);
        //     }
        // }
    }
}
...
//     if (mod.GetSoldierState(player, mod.SoldierStateBool.IsAISoldier)) {
//         // AI bot: disable targeting/shooting, set to 1 HP
//         // mod.AIEnableTargeting(player, false);
//         // mod.AIEnableShooting(player, false);
//         // mod.SetPlayerMaxHealth(player, 1);
//     } else {
//         // Human player: set to 500 HP
//         // mod.SetPlayerMaxHealth(player, 500);
//     }
// }
